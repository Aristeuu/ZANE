...
<html lang="en">
  <head>
    ...
    <title>Signin ZaneConnect</title>
...
<form action="{{route('register')}}" method="POST" id="formPost">
      @csrf
    <img class="mb-4" src="public/images/logo.png" alt="" width="100" height="100">
    <h1 class="h3 mb-3 fw-normal">Please Sign in</h1>

    <div class="form-floating">
        <input type="text" name="nome" class="form-control" id="floatingInputName" placeholder="nome" required>
    ...
    <div class="form-floating">
      <input type="password" name="password" class="form-control" id="floatingPassword" placeholder="Password" min="6"  required>
      <label for="floatingPassword">Password</label>
    </div>    
    
    <button class="w-100 btn btn-lg btn-primary" type="submit" form="formPost">Sign in</button>
