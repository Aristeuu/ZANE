...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Adicionar Produto <a href="http://" data-toggle="modal" onclick="editor(6)" data-target="#modal-default"><i class="fas fa-plus mr-1" alt="Novo" title="Novo"></i></a>
        ...
        <div class="modal fade" id="modal-default">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                         <!-- form start -->
                  <form id="ctedForm" action="{{route('produtos.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="desconto" class="form-control" id="desconto" placeholder="" >
                      </div>                                                                                 
                      <div class="form-group">
                    ...
                    <tr>                        
                        ...
                        <td>
                            @if($item->desconto != null)
                                <s>{{number_format($item->preco,2)}}</s>
                                {{number_format($item->preco - (($item->desconto/100)*$item->preco) ,2)}}  
                            @else
                                {{number_format($item->preco,2)}}  
                            @endif    
                        </td>
                        <td>@if($item->desconto != null)
                                {{$item->desconto}} %
                            @else
                                0
                            @endif         
                          ...
                          <form id="editForm{{$item->id}}" action="{{route('produtos.update', $item->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <label for="titulo">Produto</label>
                                    <input type="text" name="nome" class="form-control" id="titulo" placeholder="" required value="{{$item->nome}}">
                                  </div>    
            
                                  <div class="form-group">
                                    <label for="preco">Preco</label>
                                    <input type="number" name="preco" class="form-control" id="preco" placeholder="" required value="{{$item->preco}}"> 
                                  </div>    
                                  <div class="form-group">
                                    <label for="preco">Desconto %</label>
                                  <input type="number" name="desconto" class="form-control" id="desconto" placeholder="" value="{{$item->desconto}}">
                                  </div>                                                                              
                                  <div class="form-group">
                                    <label for="exampleInputEmail1">Descrição</label>
